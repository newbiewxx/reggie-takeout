...
├── ReggieTakeoutApplication.java   # 启动类
├── common/                          # 公共组件
...
│   ├── DishMapper.java
│   └── SetmealMapper.java
├── domain/                          # 实体类（Lombok @Data，@TableField 自动填充注解）
│   ├── Employee.java                # 员工
